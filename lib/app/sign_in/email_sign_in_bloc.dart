...
import 'package:time_traker_flutter_course/app/sign_in/email_sign_in_model.dart';
...
class EmailSignInBloc{
  ...
  Future <void> submit() async{
    ...
    try{
      if(_model.formType == EmailSignInFormType.signIn){//signIn상태라면
        await auth.signInWithEmailAndPassword(_model.email, _model.password);//로그인
      }else{
